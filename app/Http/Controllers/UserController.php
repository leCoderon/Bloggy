...
class UserController extends Controller
{
    ...
    public function handleLogin(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            return redirect()->intended('dashboard')->with('welcome', 'Ravi de vous revoir');

        }
        return redirect()->route('login')->with('fail', 'Aucun utilisateur trouvé. Vérifier vos données!');
